...
export default function UploadPage() {
  ...
  return (
    <div className="min-h-full flex flex-col bg-zinc-50">
      ...
      <main className="max-w-2xl w-full mx-auto px-8 py-12">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold tracking-tight text-zinc-900">New deal</h1>
          <p className="text-sm text-zinc-400 mt-1">Upload deal documents to start a compliance check.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div
            ...
            className={`rounded-xl border-2 border-dashed px-8 py-14 text-center transition-colors ${
              isUploading
                ...
                : dragging
                ? 'border-zinc-400 bg-zinc-50 cursor-copy'
                : 'border-zinc-200 bg-white hover:border-zinc-300 hover:bg-zinc-50 cursor-pointer'
            }`}
          >
            <div className="mx-auto mb-4 h-11 w-11 rounded-full bg-zinc-100 flex items-center justify-center">
            ...
            <p className="text-xs text-zinc-400 mt-1">PDF, PNG, JPG, TIFF</p>
            <input
              ref={inputRef}
              type="file"
              multiple
          ...
          <div>
            <button
              ...
              className="inline-flex items-center gap-2 rounded-md bg-zinc-900 px-5 py-2.5 text-sm font-medium text-white hover:bg-zinc-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
            >
              {isUploading ? (
                <>
